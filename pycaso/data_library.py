    ...
    if np.any(ptB) :
        ...
        for id_ in np.ravel(pts_list) :
            ...
            if id_ == 0 :
                ...
                xi = corners_list_opt[id_-1][0] + Lx[0]
                yi = corners_list_opt[id_-1][1] + Ly[0]
            else :
                xi = corners_list_opt[id_-len(pts_list[0])][0] + Cx[0]
                yi = corners_list_opt[id_-len(pts_list[0])][1] + Cy[0]
            xi = int(xi)
            yi = int(yi)
            d = int(len_test)
